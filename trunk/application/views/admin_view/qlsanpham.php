     ...
     <!--  breadcrumb --> 
      ...
      <div class="row">
        ...
        <div id="list_table">
                  ...
                  <?php
                    if($num_rows>0){
                        echo "<h1 class=\"heading1\"><span class=\"maintext\">Tổng số sản phẩm</span> : ".$num_rows."</h1>";
                        echo "<div style=\"font-size: large;\"> Trang ".$link."</div>";
                    }
                  ?>
                  </div>
                    ...
                    <table width="75%" cellpadding="2" cellspacing="2" class="table table-striped table-bordered">
                          ...
                          <tr style="font-weight: bold; font-size: large;">
                            <td width="20%" class="orange">Hình ảnh</td>
                            <td width="20%" class="orange">Tên sản phẩm</td>
                            <td width="20%" class="orange">Giá</td>
                            <td width="20%" class="orange">Số lượng</td>
                          ...
                          <?php
                            ...
                            if($num_rows>0){
                                foreach ($product as $item) {
                                    $count++;
                                    echo "<tr>";
                                    echo '<td class="image"><img width="50" height="50" src="'.base_url().$item['img_sp'].'"></td>';
                                    echo '<td>'.$item['name_sp'].'</td>';
                                    echo '<td>'.$item['price'].'</td>';
                                    echo '<td>'.$item['soluong'].'</td>';
                                    echo '<td class="total"><a href="'.base_url().'index.php/admin/suasanpham/'.$item['id_sp'].'"><img class="tooltip-test" data-original-title="Chỉnh Sửa" src="'.$path_img.'edit.png" alt=""></a>
                                    <a onclick="return confirm(\'Bạn có chắc chắn xóa?\');" href="'.base_url().'index.php/admin/xoasanpham/'.$item['id_sp'].'"><img class="tooltip-test" data-original-title="Xóa"  src="'.$path_img.'remove.png" alt=""></a></td>';
                                    echo "</tr>"; 
                                }
                            }
                          ?>
            ...
            <div class="control-group">
                <a href="<?php echo base_url();?>index.php/admin/themsanpham" class="btn btn-orange">Thêm sản phẩm</a>

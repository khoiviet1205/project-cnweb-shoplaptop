     ...
     <!--  breadcrumb --> 
      ...
      <div class="row">
        ...
        <div id="list_table">
                  ...
                  <?php
                    if($num_rows>0){
                        echo "<h1 class=\"heading1\"><span class=\"maintext\">Tổng số thành viên</span> : ".$num_rows."</h1>";
                  ...
                  ?>
                    ...
                    <table width="75%" cellpadding="2" cellspacing="2" class="table table-striped table-bordered">
                          ...
                          <tr style="font-weight: bold; font-size: large;">
                            <td width="20%" class="orange">Tài khoản</td>
                            <td width="20%" class="orange">Email</td>
                            <td width="20%" class="orange">Ngày thêm</td>
                            <td width="20%" class="orange">Trạng thái</td>

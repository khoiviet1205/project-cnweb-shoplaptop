 <!-- San pham moi nhat-->
  <section id="latest" class="row">
   <?php if(!empty($itemsspm)) { ?> 
    <div class="container">
      <h1 class="heading1"><span class="maintext">Sản Phẩm Mới Nhất</span><span class="subtext"><a href="<?php echo base_url();?>index.php/welcome/tatcasanpham/8"> Xem Tất Cả Sản Phẩm Mới Nhất</a></span></h1>
       <ul class="thumbnails">
      	<?php foreach($itemsspm as $item) : ?>
        <li class="span3">

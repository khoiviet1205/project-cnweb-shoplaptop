<div id="maincontainer">
  ...
  <section id="featured" class="row mt40">
    <div class="container">
      <h1 class="heading1"><span class="maintext">Sản Phẩm Nổi Bật</span><span class="subtext"> Xem Tất Cả Sản Phẩm Nổi Bật</span></h1>
      <ul class="thumbnails">
        <li class="span3">
          <a class="prdocutname" href="product.html">Lenovo G460</a>
          <div class="thumbnail">
            <span class="sale tooltip-test">Sale</span>
            <a href="#"><img alt=""  src="publics/img/product1.jpg"></a>
        ...
        <li class="span3">
          <a class="prdocutname" href="product.html">SamSung V1</a>
          <div class="thumbnail">
            <a href="#"><img alt="" src="publics/img/product2.jpg"></a>
            <div class="shortlinks">
              <a class="details" href="#">Chi Tiết</a>
              <a class="wishlist" href="#">Ưa Thích</a>
              <a class="compare" href="#">So Sánh</a>
        ...
        <li class="span3">
          <a class="prdocutname" href="product.html">Lenovo G560</a>
          <div class="thumbnail">
        ...
        <li class="span3">
          <a class="prdocutname" href="product.html">ASUS</a>
          <div class="thumbnail">
            <a href="#"><img alt="" src="publics/img/product2.jpg"></a>
            <div class="shortlinks">
              <a class="details" href="#">Chi Tiết</a>
  ...
  <section id="latest" class="row">
    <div class="container">
      <h1 class="heading1"><span class="maintext">Sản Phẩm Mới Nhất</span><span class="subtext"> Xem Tất Cả Sản Phẩm Mới Nhất</span></h1>
      <ul class="thumbnails">
        <li class="span3">
          <a class="prdocutname" href="product.html">Lenovo G460</a>
          <div class="thumbnail">
        ...
        <li class="span3">
          <a class="prdocutname" href="product.html">SamSung V1</a>
          <div class="thumbnail">
            <a href="#"><img alt="" src="publics/img/product2a.jpg"></a>
            <div class="shortlinks">
              <a class="details" href="#">Chi Tiết</a>
              <a class="wishlist" href="#">Ưa Thích</a>
              <a class="compare" href="#">So Sánh</a>
  ...
  <!-- Selling Product-->
  <section id="selling" class="row">
    <div class="container">
      <h1 class="heading1"><span class="maintext">Sản Phẩm Bán Chạy</span><span class="subtext"> Xem Tất Cả Sản Phẩm Mới Nhất</span></h1>
      <ul class="thumbnails">
        <li class="span3">
          <a class="prdocutname" href="product.html">Lenovo G460</a>
          <div class="thumbnail">

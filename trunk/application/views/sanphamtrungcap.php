 <!-- San pham trung cap-->
  <section id="latest" class="row">
   <?php if(!empty($itemsspcc)) { ?> 
    <div class="container">
      <h1 class="heading1"><span class="maintext">Sản Phẩm Trung Cấp</span><span class="subtext" ><a href="<?php echo base_url();?>index.php/welcome/tatcasanpham/7"> Xem Tất Cả Sản Phẩm Trung Cấp</a></span></h1>
       <ul class="thumbnails">
